...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/delicate-field-2e90
```

A live public deployment of this template is available at [https://delicate-field-2e90.templates.workers.dev](https://delicate-field-2e90.templates.workers.dev)
